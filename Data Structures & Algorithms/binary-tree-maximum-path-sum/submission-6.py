...
class Solution:
    def maxPathSum(self, root: Optional[TreeNode]) -> int:
        ...
        # Complexity of this:
            ...
            # Space: O(h) (around 2h recursion calls open at same time if balanced tree); = O(n) 
        # How to optimise my solution:
            # Not actually necessary to return MPS from each of the function call
            # Can keep track of maximum MPS across all paths using one global variable
            # use "nonlocal res" at start of the helper function
            # Also: can do use max of path sums and zero more often / earlier to reduce number of
            # comparisons 
