class Solution:
    def maxProfit(self, prices: List[int]) -> int:
        ...
        - Iterating through from the back, keeping track of highest possible prices and max profit
          The approach I've chosen here can also be implemented when looping forward. In that case,
          we just need to keep track of the lowest buy price rather than the highest sell price.
        """
        best_sale_price = 1
        max_profit = 0
